 ...
 */
export async function generateLessonNoteFromTemplate(data, templateUrl, outputFileName = "lesson-note.docx") {
    try {
 ...
 */
export async function generateLessonFromJson(jsonData, templateUrl, fileName) {
    try {
        // Parse JSON if string
        const lessonData = typeof jsonData === 'string' ? JSON.parse(jsonData) : jsonData;
 ...
 */
export function generateLessonFileName(data) {
