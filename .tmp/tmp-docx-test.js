import { generateLessonNoteDocx } from "./services/docxService";
import { generateGhanaLessonDocx } from "./services/ghanaLessonDocxService";
async function run() {
    ...
    const jsonData = [{ subject: "Mathematics", class: "Basic 4", classSize: "30", contentStandard: "Standard", weekEnding: "Friday", day: "Monday", duration: "40 mins", strand: "Numbers", subStrand: "Fractions", lesson: "1 of 1", phases: { phase1_starter: { duration: "10 mins", content: "Starter" }, phase2_newLearning: { duration: "40 mins", content: "New Learning" }, phase3_reflection: { duration: "10 mins", content: "Reflection" } }, indicator: "indicator", performanceIndicator: "performanceIndicator" }];
    try {
