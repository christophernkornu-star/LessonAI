                    ...
                    rows: [
                        new docx_1.TableRow({
                            children: [
                                ...
                                new docx_1.TableCell({ children: [new docx_1.Paragraph("T3 C2")], borders: tableBorders, columnSpan: 2 }),
                                new docx_1.TableCell({ children: [new docx_1.Paragraph("T3 C3")], borders: tableBorders }),
                            ]
                        })
                    ]
                }),
...
docx_1.Packer.toBuffer(doc).then(function (buffer) {
    fs.writeFileSync("test-tables-gap.docx", buffer);
    console.log("Done");
});
